  ...
  return (
    <div className="container w-full max-w-screen-xl min-h-[90vh] md:min-h-screen px-6  py-12 mx-auto">
      <div className="flex flex-col w-full min-h-screen pb-5">
        {/* 타이틀 */}
        <div className="font-bold  text-[clamp(1.875rem,6vw,6rem)] whitespace-nowrap tracking-tight m-3">
          <p>SKILLS.</p>
        </div>
        {/* 스킬 */}
        <div className="grid gap-4 px-3 md:gap-10 md:grid-cols-2 ">
          <div>
            <p className="mb-2 font-semibold text-md text-primary md:text-2xl">JavaScript.</p>
            <ul className="pl-6 space-y-2 text-sm list-disc md:text-lg">
          ...
          <div>
            <p className="mb-2 font-semibold text-md text-primary md:text-2xl">React.</p>
            <ul className="pl-6 space-y-2 text-sm list-disc md:text-lg">
          ...
          <div>
            <p className="mb-2 font-semibold text-md text-primary md:text-2xl">Database.</p>
            <ul className="pl-6 space-y-2 text-sm list-disc md:text-lg">
          ...
          <div>
            <p className="mb-2 font-semibold text-md text-primary md:text-2xl">UI System.</p>
            <ul className="pl-6 space-y-2 text-sm list-disc md:text-lg">
              <li>
                Tailwind CSS를 활용하여 반응형 레이아웃을 고려한 UI 시스템을 구축할 수 있습니다.
              </li>
              <li>Photoshop, Illustrator, Figma 등 그래픽 디자인 툴 사용에 익숙합니다.</li>
            </ul>
          </div>
          <div>
            <p className="mb-2 font-semibold text-md text-primary md:text-2xl">Communication.</p>
            <ul className="pl-6 space-y-2 text-sm list-disc md:text-lg">
