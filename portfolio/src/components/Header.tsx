...
export default function Header() {
  return (
    <header
      id="intro"
      className="flex flex-col justify-between w-full min-h-[90vh] md:min-h-screen pt-5 "
    >
      <div className="container px-6 mx-auto md:px-10">
        ...
        <div className="flex flex-col items-start justify-between h-full md:flex-row">
          ...
          <div className="grid grid-cols-[auto_max-content] items-start mb-5 md:items-center">
            <div className="flex">
              {/* 인사말 */}
              <div className="flex-1 pl-6 mt-5 md:mt-10 md:ml-8">
                <h1 className="text-3xl leading-snug md:text-4xl lg:text-5xl">
                  안녕하세요,
                  <br />
                  <span className="font-bold">정유진입니다</span>
                  <span className="font-bold period-mark">.</span>
                </h1>
                <p className="mt-8 text-lg leading-tight md:text-2xl lg:text-2xl">
                  경기권에 거주하는, <br />
                  <span className="font-bold">신입 프론트엔드 개발자</span>입니다.
                </p>
                <p className="mt-6 text-lg leading-tight md:text-2xl lg:text-2xl">
                  디자인 감각을 바탕으로 <br />
              ...
              {/* 프로필 사진 */}
              <div className="w-[100px] md:w-[110px] lg:w-[120px] mt-5 md:ml-10">
                <Image
      ...
      {/* 큰 타이틀 */}
      <div className="text-primary font-bold text-[clamp(1.875rem,7vw,6rem)] whitespace-nowrap tracking-tight text-center mb-5 md:mb-10">
