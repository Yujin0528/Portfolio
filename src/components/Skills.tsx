  ...
  return (
    <div className="container w-full max-w-screen-xl px-4 py-6 mx-auto md:px-6 md:py-12">
      <div className="flex flex-col w-full max-h-[calc(100dvh-3rem)] md:max-h-none overflow-y-auto md:overflow-visible">
        {/* 타이틀 */}
        <div className="font-bold  text-[clamp(1.875rem,6vw,6rem)] whitespace-nowrap tracking-tight mb-4 md:m-3">
          <p>SKILLS.</p>
        </div>
        {/* 스킬 */}
        <div className="grid gap-4 px-2 md:gap-10 md:grid-cols-2 ">
          <div>
            <p className="mb-2 text-base font-semibold text-primary md:text-xl lg:text-2xl ">
              JavaScript.
            </p>
            <ul className="pl-6 space-y-1.5 text-xs list-disc md:text-sm lg:text-lg">
