    ...
    <div className="container w-full max-w-screen-xl min-h-[90vh] md:min-h-screen px-6  py-12 mx-auto">
      <div className="flex flex-col w-full min-h-screen">
        ...
        <div className="grid gap-4 px-3 md:gap-10 md:grid-cols-2 ">
          <div>
            <p className="mb-2 text-md text-[var(--color-text-inverse)] font-semibold md:text-2xl ">
              숭실대학교 | 디지털미디어학과 졸업.
            </p>
            <p className="mb-2 text-sm md:mb-4 text-text-secondary md:text-lg">2021.03 - 2025.02</p>
          ...
          <div>
            ...
            <p className="mb-2 text-sm md:mb-4 text-text-secondary text-md md:text-lg">
              2025.02 - 2025. 08
            </p>
            <p className="text-sm md:text-lg">
          ...
          <div>
            ...
            <a
              className="p-1  text-xs rounded-md bg-primary-hover md:text-md text-[var(--color-text-inverse)]"
          ...
          <div>
            ...
            <p className="mb-2 text-sm md:mb-4 text-text-secondary md:text-lg">
              2022.02 - 2022. 07
            </p>
            <p className="text-sm md:text-lg">
